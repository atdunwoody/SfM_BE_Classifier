...
# # Example of usage:
# params = WorkflowParameters()  # Create base parameters
# params.add_tile_creator_params()  # Dynamically add tile creator specific parameters
# params.add_trainer_params()  # Add training specific parameters
# params.add_classifier_params()  # Add classification specific parameters
