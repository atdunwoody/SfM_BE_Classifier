...
class RF_Parameters:
    def __init__(self):
        ...
        # self.DEM_path = r"Y:\ATD\GIS\ETF\Vegetation Filtering\Model\DEM_LM2_070923_Train-val_Clip.tif"
        # self.ortho_path = r"Y:\ATD\GIS\ETF\Vegetation Filtering\Model\Ortho_LM2_070923_Train-val_Clip.tif"  
        #self.output_folder = os.path.join(os.path.dirname(self.ortho_path), 'RF_Output')
        self.output_folder = r"Y:\ATD\GIS\Veg Classification MS vs RF\MS Exports"
        ...
        self.grid_path = r"Y:\ATD\GIS\ETF\Vegetation Filtering\Model\RF_Tiled_Inputs\Grid\grid.shp"
