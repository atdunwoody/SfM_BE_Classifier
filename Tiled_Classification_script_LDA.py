...
output_folder = r"Z:\ATD\Drone Data Processing\GIS Processing\Vegetation Filtering Test\Classification_Florian\Test_v1\Test 12 Grid\Results\Results_LDA\Grid_15"
...
img_as_array = scaler.fit_transform(img_as_array)
...
sum_mat = classification_report(y_v,X_v,target_names=target_names, zero_division=0)
print(sum_mat)
